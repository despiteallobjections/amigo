...
func main() {
	// TODO(mdempsky): Re-enable -V flag.
	...
	for i, input := range goFiles {
		...
		if *trimpath != "" {
			panic("TODO: implement -trimpath support")
...
func newPackage(args []string) *Package {
	...
	// buildcfg.Check()
	gomips = os.Getenv("GOMIPS")     // buildcfg.GOMIPS
	gomips64 = os.Getenv("GOMIPS64") // buildcfg.GOMIPS64
